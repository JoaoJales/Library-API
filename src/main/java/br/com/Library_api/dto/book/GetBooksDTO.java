...
public record GetBooksDTO(Long bookId, String title, Integer publicationYear, String publisher, String genre, String isbn, GetAuthorSummaryDTO summaryAuthor) {
